...
class QrMobileVision {
  ...
  static PreviewDetails previewDetails;
  ...
  static Future<PreviewDetails> start({
    ...
    previewDetails = PreviewDetails(surfaceWidth, surfaceHeight, orientation, textureId);
      ...
      switch (call.method) {
        case 'qrRead':
          if (qrCodeHandler != null) {
            ...
            if (call.arguments['containsBarcode']) {
              call.arguments['barcodes'].forEach((ele) {
                barcodes.add(Barcode.fromJson(Map<String, dynamic>.from(ele)));
              });
            }
