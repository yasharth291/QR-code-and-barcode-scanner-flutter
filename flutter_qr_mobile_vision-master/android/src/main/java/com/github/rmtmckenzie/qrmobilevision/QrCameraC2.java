...
class QrCameraC2 implements QrCamera {
    ...
    public void start() throws QrReader.Exception {
        ...
        try {
            ...
            int cameraInt = Integer.parseInt(cameraId);
            recordingProfile = CamcorderProfile.get(cameraInt, CamcorderProfile.QUALITY_720P);
    ...
    private void startCamera() {
        ...
        reader = ImageReader.newInstance(previewSize.getWidth(), previewSize.getHeight(), ImageFormat.YUV_420_888, 5);
